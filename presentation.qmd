...
2. Minimize types of software/languages used
...
4. Centralise your workflow/sequence
...
6. Workflow management systems (WMS)
...
* Allows recovering old versions and keeping multiple versions of the same code.
Many tools available: Git, CVS, SVN, …
